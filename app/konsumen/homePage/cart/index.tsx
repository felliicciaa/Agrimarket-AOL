...
/>
      ...
      <View style={styles.bottomSection}>
        ...
        {/* Voucher Section */}
        <TouchableOpacity style={styles.voucherSection} onPress={() => router.push("/konsumen/homePage/cart/voucher" as any)}>
        ...
        <View style={styles.bottomBar}>
          <TouchableOpacity onPress={toggleAllCheck} style={styles.allCheckbox}>
           ...
           <TouchableOpacity style={styles.buyButton} onPress={() => router.push("/konsumen/homePage/cart/checkout" as any)}>
