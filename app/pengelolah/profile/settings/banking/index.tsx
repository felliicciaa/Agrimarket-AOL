...
export default function BankingScreen() {
  ...
  const handleAddAccount = () => {
    ...
    router.push('/pengelolah/profile/settings/banking/addAccount' as any)
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => router.replace("/pengelolah/profile/settings"as any)}>
