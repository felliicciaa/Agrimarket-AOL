...
export default function IdentityScreen() {
  ...
  const [formData, setFormData] = useState({
    nama: "PT. Mitra Bakti",
    deskripsi: "Pengelolah yang berkomitmen untuk menyediakan produk berkualitas tinggi dengan pelayanan terpercaya..",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.formContainer}>
          ...
          {/* Deskripsi Petani */}
          <View style={styles.inputGroup}>
            <Text style={styles.label}>Deskripsi Pengelolah</Text>
            <TextInput
              style={[styles.input, styles.textArea]}
              value={formData.deskripsi}
              onChangeText={(value) => handleInputChange("deskripsi", value)}
              placeholder="Ceritakan tentang diri Anda sebagai pengelolah"
              placeholderTextColor="#999"
              multiline
              numberOfLines={4}
