...
export default function SettingsScreen() {
  ...
  const handleMenuPress = (menuItem: string) => {
    ...
    switch (menuItem) {
      case "Uang & Rekening":
        router.push("/pengelolah/profile/settings/banking" as any)
        break
      case "Keamanan Akun":
  ...
  activeOpacity={0.7}
onPress={() => router.push("/pengelolah/profile/settings/identity" as never)}
>
  ...
  <Ionicons name="chevron-forward" size={20} color="#999" />
          ...
          <View style={styles.menuContainer}>
            <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuPress("Nama Pengelolah")}>
              <Text style={styles.menuText}>Nama Pengelolah</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuPress("Foto Pengelolah")}>
              <Text style={styles.menuText}>Foto Pengelolah</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuPress("Deskripsi Toko Pengelolah")}>
              <Text style={styles.menuText}>Deskripsi Toko Pengelolah</Text>
            </TouchableOpacity>
