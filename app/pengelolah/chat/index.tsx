...
const router = useRouter()
  ...
  const handleChatPress = () => {
    router.push("/pengelolah/chat" as any)
  }
  ...
  const renderChatItem = ({ item }: { item: ChatContact }) => (
    <TouchableOpacity style={styles.chatItem} onPress={() => router.push(`/pengelolah/chat/${item.id}` as any)}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      <BottomNavigationPengelolah activeTab="chat" />
    </SafeAreaView>
  )
}
