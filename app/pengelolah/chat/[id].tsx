...
export default function ChatDetail() {
  ...
  const getContactInfo = (contactId: string) => {
    const contacts: { [key: string]: { name: string; type: string } } = {
      "1": { name: "PT. Mitra Bakti", type: "individual" },
      "2": { name: "Distributor Bandung", type: "individual" },
      "3": { name: "Ulung Distribution", type: "individual" },
      "4": { name: "Distribusi Handal", type: "individual" },
    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        ...
        <View style={styles.header}>
          <TouchableOpacity style={styles.backButtonContainer} onPress={() => router.replace("/pengelolah/chat" as any)}>
