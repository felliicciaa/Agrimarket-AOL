...
export default function PengelolahHomeScreen() {
  ...
  const handleProductPress = (product: {
    ...
    router.push("/pengelolah/homePage/category/productDetails")
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          <TouchableOpacity style={styles.sectionHeader} onPress={() => router.push("/pengelolah/homePage/category/productDetails" as any)}>
