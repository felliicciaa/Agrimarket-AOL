...
export default function CheckoutScreen() {
    ...
    router.push("/pengelolah/homePage/cart/checkout/success-co")
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.replace("/pengelolah/homePage/cart" as any)} style={styles.backButton}>
