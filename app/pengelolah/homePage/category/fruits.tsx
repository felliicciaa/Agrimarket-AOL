...
export default function VegetablesCategoryScreen() {
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.categoryInfo}>
          ...
          <Text style={styles.categoryDescription}>
            Temukan berbagai jenis Buah segar langsung dari petani lokal! Kami menghadirkan Buah-buahan berkualitas tinggi,
  ...
  <TouchableOpacity
    ...
    onPress={() => {
       {
        router.push("/pengelolah/homePage/category/productDetails" as any);
      }
