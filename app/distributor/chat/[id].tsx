...
export default function ChatDetail() {
  ...
  const getContactInfo = (contactId: string) => {
    const contacts: { [key: string]: { name: string; type: string } } = {
      "1": { name: "PT. Distribusi Maju", type: "individual" },
      "2": { name: "PT. Distribusi Jaya", type: "individual" },
      "3": { name: "PT. Distribusi Ayam", type: "individual" },
      "4": { name: "PT. Distribusi Biru", type: "individual" },
      "5": { name: "娜娜欧阳", type: "company" },
    }
    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        ...
        <View style={styles.header}>
          <TouchableOpacity style={styles.backButtonContainer} onPress={() => router.replace("/distributor/chat" as any)}>
