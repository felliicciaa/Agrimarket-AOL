...
export default function SettingsScreen() {
  ...
  const handleMenuPress = (menuItem: string) => {
    ...
    switch (menuItem) {
      case "Uang & Rekening":
        router.push("/distributor/profile/settings/banking" as any)
        break
      case "Keamanan Akun":
      ...
      case "Nama Distributor":
        ...
        break
      case "Foto Distributor":
        console.log("Navigate to edit farmer photo")
        break
      case "Deskripsi Toko Distributor":
  ...
  activeOpacity={0.7}
onPress={() => router.push("/distributor/profile/settings/identity" as never)}
>
  ...
  <Ionicons name="chevron-forward" size={20} color="#999" />
          ...
          <View style={styles.menuContainer}>
            <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuPress("Nama Distributor")}>
              <Text style={styles.menuText}>Nama Distributor</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuPress("Foto Distributor")}>
              <Text style={styles.menuText}>Foto Distributor</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handleMenuPress("Deskripsi Toko Distributor")}>
              <Text style={styles.menuText}>Deskripsi Toko Distributor</Text>
            </TouchableOpacity>
