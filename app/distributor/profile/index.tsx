...
export default function DistributorProfileScreen() {
  const handleSettingsPress = () => {
    router.push("/distributor/profile/settings" as any)
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        {/* Company Description */}
        <Text style={styles.roleTitle}>Distributor Mitra Bakti</Text>
          ...
          <View style={styles.infoCardContent}>
            ...
            <View style={styles.infoCardTextContainer}>
              ...
              <Text style={styles.infoCardDescription}>
                Distributor yang berpengalaman untuk menyediakan produk berkualitas tinggi dengan pelayanan terpercaya.
              </Text>
            </View>
          </View>
        </View>
      ...
      {/* Bottom Navigation */}
      <BottomNavigationDistributor activeTab="profil" />
    </SafeAreaView>
  )
}
