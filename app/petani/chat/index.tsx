...
const router = useRouter()
  ...
  const handleChatPress = () => {
    router.push("/petani/chat" as any)
  }
  const chatContacts: ChatContact[] = [
    ...
    },
    {
      id: "5",
      name: "PT. Mitra Bakti",
      lastMessage: "Tolong baca pesan yang telah di...",
      avatar: "/placeholder.svg?height=50&width=50",
      timestamp: "Kemarin",
    },
  ]
  ...
  const renderChatItem = ({ item }: { item: ChatContact }) => (
    <TouchableOpacity style={styles.chatItem} onPress={() => router.push(`/petani/chat/${item.id}` as any)}>
